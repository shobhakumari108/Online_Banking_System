...
public interface AccountantDao {
	...
	public boolean InsertCustomer(String Name,String Username, String password,int AccountNo,int Amount) throws CustomerException;
	
	public boolean UpdateCusomer(String Name,String Username, String password,int AccountNo,int Amount, int Trans_ID)  throws CustomerException;
